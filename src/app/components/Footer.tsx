      ...
      <div className="max-w-[1400px] mx-auto pt-14 lg:pt-24  px-6">
        <div className="bg-[#263238] p-6 md:p-12 flex flex-col gap-4 md:flex-row justify-between md:items-center  mx-auto mb-10 md:mb-14">
          <div>
            ...
            <h2 className="text-left uppercase fade-up-stagger text-2xl lg:text-[44px] max-w-[450px] font-semibold leading-none text-white">
             Join Our <span className='text-site'>Private Investment Circle</span>
            </h2>
            <p className="opacity-80 text-sm md:text-[16px] font-light2 mt-3 ">Secure off-market alpha and exclusive Solaris market analysis before public release.</p>
          </div>
          <AnimatedButton type="submit"
            label="Let's Talk With Us" className="w-fit transparent-btn transparent-btn" />
        </div>
