    ...
    <>
      <section className="py-14  lg:py-24   mx-auto  ">
        <div className="max-w-[1240px] px-4 lg:px-6 mx-auto grid grid-cols-1 gap-8 ">
            ...
            <ul className="mt-6 lg:mt-10 grid lg:grid-cols-3 gap-4">
              <li className="flex items-center flex-col gap-4 bg-white rounded-2xl p-6 lg:p-10">
                ...
                <div className="flex flex-col gap-1 text-center">
                  ...
                  <span className=" text-sm font-light">Al Saqar Business Tower, 13th Floor, Sheikh Zayed Road</span>
                </div>
              </li>
              ...
              <li className="flex items-center flex-col gap-4 bg-white rounded-2xl p-6 lg:p-10">
                ...
                <div className="flex flex-col gap-1 text-center">
                  ...
                  <a href="mailto:Info@safeattestuae.com" className=" text-sm font-light">Info@safeattestuae.com</a>
                </div>
              </li>
              <li className="flex items-center flex-col gap-4 bg-white rounded-2xl p-6 lg:p-10">
                <span className="border border-[var(--siteColor)] p-2 rounded-full  w-16 h-16 flex items-center justify-center">
                ...
                <div className="flex flex-col gap-1 text-center">
                  ...
                  <span className=" text-sm font-light">+971 50 954 8130</span>
                </div>
              </li>
          ...
          >
            <h4 className="xl lg:text-3xl font-semibold max-w-xl">Feel Free to Get in Touch or Visit our
              Location.</h4>
