...
export default function ContactSection() {
  ...
  return (
    <>
      <section className="bg-[var(--background2)] py-14  lg:py-24  mx-auto  ">
        <div className="max-w-[1400px] px-4 lg:px-6 mx-auto flex gap-8 flex-wrap ">

          {/* <form
            onSubmit={handleSubmit}
            className=" bg-[#ffffffc9] lg:p-12 p-6 space-y-8 lg:w-[calc(100%-440px)]"
          >
            <h4 className="text-2xl lg:text-5xl font-semibold max-w-xl md:pb-10">Feel Free to Get in Touch or Visit our
              Location.</h4>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-7">

              <input
                name="name"
                className="w-full bg-[#ffffffc9] border-b-[#00000063] border-b py-3 focus:outline-none placeholder-[#BFBCBC]"
                type="text"
            ...
            <div>
              ...
              <textarea
                name="message"
                className="w-full bg-[#ffffffc9] border-b-[#00000063] border-b min-h-[140px] py-3 focus:outline-none resize-none placeholder-[#BFBCBC]"
                rows={3}
          ...
          <div className="w-full">
            <motion.div
              ...
              transition={{ duration: 0.5 }} className="heading flex flex-col gap-2  mb-10 max-w-[600px]">
              ...
              <h2 ref={fadeRef} className="fade-up-stagger text-3xl lg:text-[54px]  font-bold leading-none">
                Have Any Questions? 
            ...
            <ul className="grid grid-cols-3 gap-4 mt-6">
              <li className="flex items-center flex-col gap-4 bg-[#ffffffc9]  p-6 lg:p-10">
              ...
              <li className="flex items-center flex-col gap-4 bg-[#ffffffc9]  p-6 lg:p-10">
                ...
                <div className="flex flex-col gap-1 text-center">
                  ...
                  <a href="mailto:rajup@hostonpdl.com" className=" text-sm font-light">rajup@hostonpdl.com</a>
                  <a href="mailto:hpdl0007@gmail.com" className=" text-sm font-light">hpdl0007@gmail.com</a>
